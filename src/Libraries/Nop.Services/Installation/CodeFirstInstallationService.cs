...
namespace Nop.Services.Installation
{
    public partial class CodeFirstInstallationService : IInstallationService
    {
        ...
        protected virtual void InstallLanguages()
        {
            ...
            var languageVietNamese = new Language
            {
                Name = "Vietnamese",
            ...
            _languageRepository.Insert(languageVietNamese);
        }
        ...
        protected virtual void InstallLocaleResources()
        {
            ...
            //'Vietnamse' language
            var languageVietnamese = _languageRepository.Table.Single(l => l.Name == "Vietnamese");

            //save resources
            foreach (var filePath in System.IO.Directory.EnumerateFiles(CommonHelper.MapPath("~/App_Data/Localization/"), "vi.xml", SearchOption.TopDirectoryOnly))
            {
                var localesXml = File.ReadAllText(filePath);
                var localizationService = EngineContext.Current.Resolve<ILocalizationService>();
                localizationService.ImportResourcesFromXml(languageVietnamese, localesXml);
            }
        ...
        protected virtual void InstallCustomersAndUsers(string defaultUserEmail, string defaultUserPassword)
        {
            ...
            //second user
            var secondUserEmail = "steve_gates@njkhanh.com";
            ...
            //third user
            var thirdUserEmail = "arthur_holmes@njkhanh.com";
            ...
            //fourth user
            var fourthUserEmail = "james_pan@njkhanh.com";
            ...
            //fifth user
            var fifthUserEmail = "brenda_lindgren@njkhanh.com";
            ...
            //sixth user
            var sixthUserEmail = "victoria_victoria@njkhanh.com";
        ...
        protected virtual void InstallOrders()
        {
            ...
            //first order
            var firstCustomer = _customerRepository.Table.First(c => c.Email.Equals("steve_gates@njkhanh.com"));
            ...
            var firstOrderItem3 = new OrderItem()
            {
                ...
                PriceExclTax = 25M,
                OriginalProductCost = decimal.Zero,
                AttributeDescription = "From: Steve Gates &lt;steve_gates@njkhanh.com&gt;<br />For: Brenda Lindgren &lt;brenda_lindgren@njkhanh.com&gt;",
                AttributesXml = "<Attributes><GiftCardInfo><RecipientName>Brenda Lindgren</RecipientName><RecipientEmail>brenda_lindgren@njkhanh.com</RecipientEmail><SenderName>Steve Gates</SenderName><SenderEmail>steve_gates@gmail.com</SenderEmail><Message></Message></GiftCardInfo></Attributes>",
                Quantity = 1,
                DiscountAmountInclTax = decimal.Zero,
                DiscountAmountExclTax = decimal.Zero,
                DownloadCount = 0,
            ...
            var firstOrderGiftcard = new GiftCard
            {
                ...
                RecipientEmail = "brenda_lindgren@njkhanh.com",
                SenderName = "Steve Gates",
                SenderEmail = "steve_gates@njkhanh.com",
            ...
            //second order
            var secondCustomer = _customerRepository.Table.First(c => c.Email.Equals("arthur_holmes@njkhanh.com"));
            ...
            //third order
            var thirdCustomer = _customerRepository.Table.First(c => c.Email.Equals("james_pan@njkhanh.com"));
            ...
            //fourth order
            var fourthCustomer = _customerRepository.Table.First(c => c.Email.Equals("brenda_lindgren@njkhanh.com"));
            ...
            //fifth order
            var fifthCustomer = _customerRepository.Table.First(c => c.Email.Equals("victoria_victoria@njkhanh.com"));
        ...
        protected virtual void InstallSettings(bool installSampleData)
        {
            ...
            settingService.SaveSetting(new StoreInformationSettings
            {
                ...
                FacebookLink = "http://www.facebook.com/njkhanh",
                TwitterLink = "https://twitter.com/njkhanh",
                YoutubeLink = "http://www.youtube.com/user/njkhanh",
            ...
            var news = new List<NewsItem>
                                {
                                    new NewsItem
                                    {
                                         ...
                                         Language = defaultLanguage,
                                         Title = "About shop",
                                         Short = "It's stable and highly usable. From downloads to documentation, www.njkhanh.com offers a comprehensive base of information, resources, and support to the njkhanh community.",
                                         Full = "<p>For full feature list go to <a href=\"http://www.njkhanh.com\">njkhanh.com</a></p><p>Providing outstanding custom search engine optimization, web development services and e-commerce development solutions to our clients at a fair price in a professional manner.</p>",
                                         Published  = true,
                                         CreatedOnUtc = DateTime.UtcNow,
                                    },
                                    new NewsItem
                                    {
                                         AllowComments = true,
                                         Language = defaultLanguage,
                                         Title = "shop new release!",
                                         Short = "shop includes everything you need to begin your e-commerce online store. We have thought of everything and it's all included! print shop is a fully customizable shopping cart",
                                         Full = "<p>shop includes everything you need to begin your e-commerce online store. We have thought of everything and it's all included!</p>",
                                         Published  = true,
                                         CreatedOnUtc = DateTime.UtcNow.AddSeconds(1),
                                    },
                                    new NewsItem
                                    {
                                         ...
                                         Short = "The new njkhanh store is open now! We are very excited to offer our new range of products. We will be constantly adding to our range so please register on our site.",
