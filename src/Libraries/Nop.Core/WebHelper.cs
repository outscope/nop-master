...
namespace Nop.Core
{
    ...
    public partial class WebHelper : IWebHelper
    {
        ...
        protected virtual bool TryWriteGlobalAsax()
        {
            try
            {
                //When a new plugin is dropped in the Plugins folder and is installed into shop, 
                ...
                //The issue is described here: http://www.njkhanh.com/boards/t/10969/nop-20-plugin.aspx?p=4#51318
        ...
        public virtual string ServerVariables(string name)
        {
            ...
            try
            {
                ...
                //as described here http://www.njkhanh.com/boards/t/21356/multi-store-roadmap-lets-discuss-update-done.aspx?p=6#90196
        ...
        public virtual void RestartAppDomain(bool makeRedirect = false, string redirectUrl = "")
        {
            ...
            else
            {
                ...
                if (!success)
                {
                    throw new NopException("print shop needs to be restarted due to a configuration change, but was unable to do so." + Environment.NewLine +
