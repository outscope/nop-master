    ...
    public partial class BBCodeHelper
    {
            ...
            bool replaceUnderline, bool replaceUrl, bool replaceCode, bool replaceQuote, bool replaceImg)
        {
            ...
            if (replaceUrl)
            {
                ...
                // format the url tags: [url=http://www.njkhanh.com]my site[/url]
                // becomes: <a href="http://www.njkhanh.com">my site</a>
                text = regexUrl1.Replace(text, string.Format("<a href=\"$1\" rel=\"nofollow\"{0}>$2</a>", newWindow ? " target=_blank" : ""));

                // format the url tags: [url]http://www.njkhanh.com[/url]
                // becomes: <a href="http://www.njkhanh.com">http://www.njkhanh.com</a>
            ...
            if (replaceImg)
            {
                // format the img tags: [img]http://www.njkhanh.com/Content/Images/Image.jpg[/img]
                // becomes: <img src="http://www.njkhanh.com/Content/Images/Image.jpg">
