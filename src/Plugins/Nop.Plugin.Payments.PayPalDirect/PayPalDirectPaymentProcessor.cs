        ...
        public ProcessPaymentResult ProcessRecurringPayment(ProcessPaymentRequest processPaymentRequest)
        {
            ...
            try
            {
                ...
                var billingPlan = new Plan
                {
                    ...
                    description = string.Format("printshop billing plan for the {0} order", processPaymentRequest.OrderGuid),
                    type = "fixed",
                    ...
                    payment_definitions = new List<PaymentDefinition>
                    {
                        ...
                        {
                             name = "printshop payment for the billing plan",
                             type = "REGULAR",
                ...
                {
                    name = string.Format("printshop subscription for the {0} order", processPaymentRequest.OrderGuid),
