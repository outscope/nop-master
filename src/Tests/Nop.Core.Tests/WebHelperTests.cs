...
namespace Nop.Core.Tests
{
    ...
    public class WebHelperTests
    {
        ...
        public void Can_get_storeLocation_in_virtual_directory()
        {
            var serverVariables = new NameValueCollection();
            serverVariables.Add("HTTP_HOST", "www.example.com");
            _httpContext = new FakeHttpContext("~/njkhanhpath", "GET", null, null, null, null, null, serverVariables);
            _webHelper = new WebHelper(_httpContext);
            _webHelper.GetStoreLocation(false).ShouldEqual("http://www.example.com/njkhanhpath/");
        }
